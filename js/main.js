...
alert("ekrana yazi ver")
   ...
   newbtn.innerText = "edit" //teze btn ya at veririk
   li.appendChild(newbtn) //yeni buttona li ye elave edirikki yazilarin yaninda cixsin

   newbtn.classList.add("btn_new_style") // yeni yaratdigimiz btn da elave style yaratmag ucun yeni yeni 2 ci klass veririk ve scss de cagiirib style veririk
